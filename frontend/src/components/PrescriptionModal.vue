<template>
  <ion-modal :is-open="isOpen" @didDismiss="closeModal" class="prescription-modal">
    <div class="modal-wrapper">
      <div class="modal-header">
        <span class="modal-title">Prescription</span>
...
export default defineComponent({
  ...
  props: {
    ...
    generatedFilename: { type: String, default: "prescription.docx" },
  ...
  setup(props, { emit }) {
    ...
    const buildPayload = () => ({
      ...
      patient_type: props.form?.patient_type ?? "",
      maintenance: (props.form?.maintenance ?? "").toString().trim(),
      reason_for_referral: (props.form?.reason_for_referral ?? "").toString().trim(),
      medications: Array.isArray(props.form?.medications) ? props.form.medications : [],
    });
    ...
    const fetchPdfPreview = async () => {
      ...
      try {
        const res = await axios.post(
          `${baseUrl}/api/doctor/prescription/generate`,
          buildPayload(),
    ...
    const saveAsWord = () => {
      ...
      a.href = url;
      a.download = props.generatedFilename || "prescription.docx";
      a.click();
...
<style scoped>
.prescription-modal::part(content) {
